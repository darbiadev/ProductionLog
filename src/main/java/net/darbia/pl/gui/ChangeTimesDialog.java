...
class ChangeTimesDialog {
  ...
  private void initialize(final ResourceBundle messages) {
    ...
    btnCancel.addActionListener(evt -> {
      if (JOptionPane.showConfirmDialog(null, messages.getString("Cancel?"),
          messages.getString("Cancel?"), 0) == 0) {
    ...
    btnSave.addActionListener(evt -> {
      ...
      check = false;
      try {
        this.dss = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker.toString())).withDate(epoch);
      ...
      try {
        this.dse = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker2.toString())).withDate(epoch);
      ...
      try {
        this.dls = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker3.toString())).withDate(epoch);
      ...
      try {
        this.dle = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker4.toString())).withDate(epoch);
      ...
      try {
        this.nss = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker5.toString())).withDate(epoch);
      ...
      try {
        this.nse = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker6.toString())).withDate(epoch);
      ...
      try {
        this.nls = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker7.toString())).withDate(epoch);
      ...
      try {
        this.nle = new DateTime(
            ChangeTimesDialog.timeFormatRead.parseDateTime(timePicker8.toString()));
      ...
      if (!problems) {
        message = new String[]{String.format(
            messages.getString("DayShift") + "" + messages.getString("Hours") + " "
                + messages.getString("Minutes"),
            ChangeTimesDialog.timeFormatDisplay.print(this.dss),
            ChangeTimesDialog.timeFormatDisplay.print(this.dse),
            new Period(this.dss, this.dse).getHours(),
            new Period(this.dss, this.dse).getMinutes()), String.format(
            messages.getString("DayShiftLunch") + "" + messages.getString("Hours") + ""
                + messages.getString("Minutes"),
            ChangeTimesDialog.timeFormatDisplay.print(this.dls),
            ChangeTimesDialog.timeFormatDisplay.print(this.dle),
            new Period(this.dls, this.dle).getHours(),
            new Period(this.dls, this.dle).getMinutes()), String.format(
            messages.getString("NightShift") + "" + messages.getString("Hours") + ""
                + messages.getString("Minutes"),
            ChangeTimesDialog.timeFormatDisplay.print(this.nss),
            ChangeTimesDialog.timeFormatDisplay.print(this.nse),
            new Period(this.nss, this.nse).getHours(),
            new Period(this.nss, this.nse).getMinutes()), String.format(
            messages.getString("NightShiftLunch") + "" + messages.getString("Hours") + ""
                + messages.getString("Minutes"),
            ChangeTimesDialog.timeFormatDisplay.print(this.nls),
            ChangeTimesDialog.timeFormatDisplay.print(this.nle),
            new Period(this.nls, this.nle).getHours(),
            new Period(this.nls, this.nle).getMinutes())};
        if (JOptionPane.showConfirmDialog(null, message, messages.getString("Save?"), 0) == 0) {
          check = true;
        }
      }
      if (check) {
        newTimes = new HashMap<>();
